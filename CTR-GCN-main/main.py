...
def get_parser():
    ...
    parser.add_argument(
        '--config',
        default='./config/uav/joint_motion.yaml',
...
class Processor():
    ...
    def eval(self, epoch, save_score=False, loader_name=['test'], wrong_file=None, result_file=None):
        ...
        all_predictions = []  # 用于存储所有样本的所有类别预测结果
        ...
        for ln in loader_name:
            ...
            for batch_idx, (data, label, index) in enumerate(process):
                ...
                with torch.no_grad():
                    ...
                    all_predictions.append(output.data.cpu().numpy())
            ...
            if accuracy > self.best_acc:
                ...
                with open(f'{self.arg.work_dir}/best.pkl', 'wb') as f:
                    pickle.dump(best_results, f)
                self.print_log(f'Best predictions saved to {self.arg.work_dir}/best.pkl')
